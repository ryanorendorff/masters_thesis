...
\lstinputlisting[language=Matlab, basicstyle=\tiny,frame=none]{code/ceas.m}

\section{Plotting CEAS Matlab Code}

\lstinputlisting[language=Matlab, basicstyle=\tiny,frame=none]{code/plotceas.m}

\section{Loading CamTIFF Files in Matlab}

Requires jsonlab toolbox \url{http://iso2mesh.sf.net/cgi-bin/index.cgi?jsonlab}

\lstinputlisting[language=Matlab, basicstyle=\tiny,frame=none]{code/loadcamtiff.m}
