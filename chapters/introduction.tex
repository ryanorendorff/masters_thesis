...
%The objective of this report is to perform two functions. The first is to validate previous \ac{BBCEAS} results, and perform an analysis of the errors that occur when using a \ac{BBCEAS} instrument. With this investigation completed, a
