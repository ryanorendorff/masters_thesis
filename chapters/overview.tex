...
The Beer-Lambert law relates the loss of light in a material to the
...
\marginpar{This section talks about atoms but the concepts apply to molecules as well}
...
\marginpar{The mirror reflectivity curves depend on the alignment of the
cavity as well as the mirror surfaces due to interference effects. As such, it
is not possible to use mirror transmission curves provided by a manufacturer
\cite{Berden:2009wk}.}
