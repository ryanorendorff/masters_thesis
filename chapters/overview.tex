...
Both of these effects act alter the absorption peaks in a spectra of an
...
with minimal changes in index of refraction are candidates good candidates
for absorption spectroscopy, given that the experimenter does not require an
...
of an air-bourne hygrometer can be found in \cite{May:1993tu}.}
