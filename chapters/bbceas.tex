...
Several research groups have started experimenting with liquid phase
...
Once this information has been gathered, the \ac{BBCEAS} equation is used
...
\marginpar{Tools and file specifications for CamTIFF, as well as the source
for Apollo, can be found at \url{https://github.com/LaserAnalytics/}}
...
\marginpar{The assumption that intracavity losses are caused by absorption
only fails for turbid solutions.}
...
\marginpar{The mirrors both have a curvature of $r=1000\text{\,mm}$.}
...
\marginpar{\mbox{}\\\vspace{-5.5em}The spectrometer is made with an off the
shelf \ac{CCD} and two 2'', 75\,mm focal length achromatic lenses with a
transmission grating. The first order is imaged onto the CCD. The spectral
resolution obtained is around 4\,nm \textsc{fwhm}.}
...
Lambertian light sources such as \acp{LED}, on the other hand, suffer from
